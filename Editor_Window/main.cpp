...
#include "..\\WBEngine_Source\\wbToolScene.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    MyRegisterClass(hInstance, L"TITLEWINDOW", WndTileProc);
    // 애플리케이션 초기화를 수행합니다:
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   HWND ToolHWnd = CreateWindowW(L"TITLEWINDOW", L"TileWindows", WS_OVERLAPPEDWINDOW,
